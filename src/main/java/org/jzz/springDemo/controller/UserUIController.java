...
public class UserUIController{
    ...
    public String resgist(Model model){
        model.addAttribute("msg", "欢迎！请注册！");
    ...
    public String listFile(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		//return "redirect:listfile";	 //被解析为一个url
		//return "forward:listfile";		//同样被解析为一个url, 只是是forward过去的
		return "listfile";	//只有这样才会跟jsp页面关联起来
    }
